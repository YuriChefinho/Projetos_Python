...
while True:
    ...
    if cardápio == 1:
        ...
        if cardápio_yakissoba == 1:
            ...
            if compra == 1:
                total += valor_yaki_tradicional 
                print('!!!OBRIGADO PELA COMPRA!!!')
                print(' 1 - Yakissoba Tradicional | R${:.2f} \n\n\nVALOR TOTAL = R${:.2f}'.format(valor_yaki_tradicional,total))
            else:
                print('VOLTE SEMPRE! ')
            ...
            compra = int(input('SIM [1] \nNÃO [2] : '))
            if compra == 1:
                total += valor_yaki_especial
                print('!!!OBRIGADO PELA COMPRA!!!')
                print(' 1 - Yakissoba Especial | R${:.2f} \n\n\nVALOR TOTAL = R${:.2f}'.format(valor_yaki_especial,total))
            else:
                print('VOLTE SEMPRE! ')
            ...
            if compra == 1:
                total += valor_yaki_vegetariano
                print('!!!OBRIGADO PELA COMPRA!!!')
                print(' 1 - Yakissoba Vegetariano | R${:.2f} \n\n\nVALOR TOTAL = R${:.2f}'.format(valor_yaki_vegetariano,total))
            else:
                print('VOLTE SEMPRE! ')
